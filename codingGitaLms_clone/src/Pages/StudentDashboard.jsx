    ...
    <div className="min-h-screen pt-20 bg-neutral-950 text-white">
      ...
      <div className="mx-auto pb-10 max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <TopCard title="Subjects" value={user.subjects?.length || 0} />
        </div>
        ...
        <AssignmentsCard
          ...
          pending={user.pendingAssignments || 0}
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <SmallCard title="Attendance" text="View your records" link="/attendance" />
          <SmallCard title="Calendar" text="Check events & leaves" link="/calendar" />
          <SmallCard title="Chat" text="View Chat Groups" />
        </div>
      </div>
    </div>
  );
